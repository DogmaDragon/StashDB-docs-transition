---
title: Destroying Performers
hide:
---

# Destroying Performers

Guidelines unique to the removal of an existing performer are listed below, roughly sorted by importance. Individual guidelines are also listed in the right-hand sidebar for quick navigation.
...
!!! info
    ...
    There are currently no written guidelines relating to this subject. If you would like to suggest one, please see [this page](LINKZ) for more information.
